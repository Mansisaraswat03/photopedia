...
const Register = () => {
  ...
  return (
    <div className="container w-full mx-auto p-1 mt-5">
      <div className="w-full max-w-md bg-white shadow border p-4 mx-auto">
        <p className="text-center font-bold my-2 text-xl">
          Welcome to Photopedia
        </p>
        <form>
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              ...
              {Boolean(data.profilePic?.name) ? (
                <p>{data.profilePic?.name}</p>
              ) : (
          ...
          <button className="bg-blue-700 hover:bg-blue-800 py-2 px-4 font-semibold text-white rounded my-2 flex mx-auto">
            Register
          </button>
        </form>
        <div className='my-5'>
